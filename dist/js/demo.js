...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('SGVA')) < Date.now()) {
      localStorage.setItem('SGVA', (Date.now()) + (15 * 60 * 1000))
  ...
  $container.append(
    '<h5>Personalizador Ventana</h5><hr class="mb-2"/>'
  )
