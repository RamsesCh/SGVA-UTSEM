...
<?php require'plantilla.php'; ?>  
  ...
  <section class="content-header">
    ...
    $insertar =$mysqli->query("INSERT INTO documentos VALUES('','$nombreDocumento','$tipoVisita','$estatusDocumento', '$fechaCreacionDocumento', '$idUsuario')");
    ...
    ?>
              ...
              <form name="form1" id="form1" class="form-horizontal row-fluid" action="formulario_documentos.php" method="POST" >
                <div class="card-body">
                  ...
                  <div class="form-group">
                   <!-- <label for="fechaInicio">Fecha inicial para cagar este documento</label> -->
                    <input hidden type="date" class="form-control" name="fechaInicio" id="fechaInicio" placeholder="Nombre del documento a solicitar" value="00/00/0000" >
                  </div>
                  <div class="form-group">
                   <!--  <label for="fechaFin">Fecha límite para cagar este documento</label> -->
                    <input hidden type="date" class="form-control" name="fechaFin" id="fechaFin" placeholder="Nombre del documento a solicitar" value="00/00/0000">
                  </div>
                 ...
                 <!-- <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="estatusDocumento" id="estatusDocumento" value="Activo" hidden>
                  <?php
               ...
               <div class="card-footer">
                        ...
                        <button type="submit" name="input" id="input" class="btn btn-sm btn-success">Crear</button>
                                               ...
                                               <a href="mostrar_documentos.php" class="btn btn-sm btn-warning">Mostras documentos</a>
