...
<?php require'plantilla.php'; ?>  
 ...
 <div class="wrapper">
  <div class="content-wrapper">
    ...
    $nombreCompleto = $_POST['nombrePermiso'];
   ...
   // ,'$telefono','$correo','$permiso', '$contraseña', '$rol'
    $insertar =$mysqli->query("INSERT INTO permisos VALUES('','$nombreCompleto', '$usuarioRol', '$usuarioC', '$usuarioR', '$usuarioU', '$usuarioD', '$documentoRol', '$documentoC', '$documentoA', '$documentoR', '$documentoU', '$documentoD', '$visitasRol', '$visitasC', '$visitasA', '$visitasR', '$visitasU', '$visitasD', '$alumnoRol', '$alumnoC', '$alumnoV', '$alumnoR', '$alumnoU', '$alumnoD', '$actividadRol', '$actividadC', '$actividadA', '$actividadR', '$actividadU', '$actividadD', '$permisoRol', '$permisoC', '$permisoR', '$permisoU', '$permisoD', '$fechaCreacion', '$creadoPor', '$fechaModificacion', '$modificadoPor', '$estatusUsuario', '$comentarios' )");
   ...
   if($insertar){
    ...
    ?>
              ...
              <form name="form1" id="form1" class="form-horizontal row-fluid" action="crear_perfil.php" method="POST" >
                <div class="card-body">
                 <!--
              ...
              <div class="card-body">
                   ...
                   <div class="form-group">
                    <label for="nombrePermiso">Nombre perfil</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="permisoRol" id="permisoRol" value="Activo">
                          <label for="permisoRol" class="custom-control-label">Perfil usuario</label>
                        </div><hr>

                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="permisoC" id="permisoC" value="Activo">
                          <label for="permisoC" class="custom-control-label">Crear perfil</label>
                        </div>
                        <!-- <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="permisoA" id="permisoA" value="Activo">
                          <label for="permisoA" class="custom-control-label">Archivar permisos</label>
                        </div> -->
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="permisoR" id="permisoR" value="Activo">
                          <label for="permisoR" class="custom-control-label">Ver perfil</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="permisoU" id="permisoU" value="Activo">
                          <label for="permisoU" class="custom-control-label">Modificar perfil</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                          <input class="custom-control-input" type="checkbox" name="permisoD" id="permisoD" value="Activo">
                  ...
                  $fecha_actual= date("Y-m-d");
                   ...
                   ?>
                  <input type="date" class="form-control" name="estatusPermiso" id="estatusPermiso" value="Activo" hidden>
